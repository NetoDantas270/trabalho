  ...
  void _filterProducts(String searchTerm) {
    setState(() {
      ...
      if (searchTerm.isEmpty) {
        // Caso a barra de pesquisa esteja vazia, ative o filtro 'Educação'
        filteredProducts = allProducts.where((product) => product.tags.contains('Educação')).toList();
      } else {
        // Caso contrário, aplique os filtros normais
        filteredProducts = allProducts.where((product) {
          return (ignoreInitialFilter || product.tags.contains('Educação') || searchTerm.isNotEmpty) &&
              (searchTerm.isEmpty ||
