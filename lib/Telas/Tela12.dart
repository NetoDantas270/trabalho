...
class Tela12 extends StatefulWidget {
  @override
  _Tela12State createState() => _Tela12State();
}

class _Tela12State extends State<Tela12> {
  ...
  void _filterProducts(String searchTerm) {
    setState(() {
      ...
      if (searchTerm.isEmpty) {
        // Caso a barra de pesquisa esteja vazia, ative o filtro 'Transporte'
        filteredProducts = allProducts.where((product) => product.tags.contains('Transporte')).toList();
      } else {
        // Caso contrário, aplique os filtros normais
        filteredProducts = allProducts.where((product) {
          return (ignoreInitialFilter || product.tags.contains('Transporte') || searchTerm.isNotEmpty) &&
              (searchTerm.isEmpty ||
