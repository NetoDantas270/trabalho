...
class Tela7 extends StatefulWidget {
  @override
  _Tela7State createState() => _Tela7State();
}
  ...
  void _filterProducts(String searchTerm) {
    setState(() {
      ...
      if (searchTerm.isEmpty) {
        // Caso a barra de pesquisa esteja vazia, ative o filtro 'Hotelaria'
        filteredProducts = allProducts.where((product) => product.tags.contains('Hotelaria')).toList();
      } else {
        // Caso contrário, aplique os filtros normais
        filteredProducts = allProducts.where((product) {
          return (ignoreInitialFilter || product.tags.contains('Hotelaria') || searchTerm.isNotEmpty) &&
              (searchTerm.isEmpty ||
