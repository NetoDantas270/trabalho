  ...
  void _filterProducts(String searchTerm) {
    setState(() {
      ...
      if (searchTerm.isEmpty) {
        // Caso a barra de pesquisa esteja vazia, ative o filtro 'Entretenimento'
        filteredProducts = allProducts.where((product) => product.tags.contains('Entretenimento')).toList();
      } else {
        // Caso contrário, aplique os filtros normais
        filteredProducts = allProducts.where((product) {
          return (ignoreInitialFilter || product.tags.contains('Entretenimento') || searchTerm.isNotEmpty) &&
              (searchTerm.isEmpty ||
