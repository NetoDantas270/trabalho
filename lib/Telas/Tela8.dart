  ...
  void _filterProducts(String searchTerm) {
    setState(() {
      ...
      if (searchTerm.isEmpty) {
        // Caso a barra de pesquisa esteja vazia, ative o filtro 'Limpeza'
        filteredProducts = allProducts.where((product) => product.tags.contains('Limpeza')).toList();
      } else {
        // Caso contrário, aplique os filtros normais
        filteredProducts = allProducts.where((product) {
          return (ignoreInitialFilter || product.tags.contains('Limpeza') || searchTerm.isNotEmpty) &&
              (searchTerm.isEmpty ||
