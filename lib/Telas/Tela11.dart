...
class Tela11 extends StatefulWidget {
  @override
  _Tela11State createState() => _Tela11State();
}

class _Tela11State extends State<Tela11> {
  ...
  void _filterProducts(String searchTerm) {
    setState(() {
      ...
      if (searchTerm.isEmpty) {
        // Caso a barra de pesquisa esteja vazia, ative o filtro 'Saúde'
        filteredProducts = allProducts.where((product) => product.tags.contains('Saúde')).toList();
      } else {
        // Caso contrário, aplique os filtros normais
        filteredProducts = allProducts.where((product) {
          return (ignoreInitialFilter || product.tags.contains('Saúde') || searchTerm.isNotEmpty) &&
              (searchTerm.isEmpty ||
